import svgPaths from "./svg-oe6rrqjwd2";
...
function PrimitiveDiv3() {
  return <div className="absolute bg-[rgba(255,255,255,0)] h-[677.594px] left-[530.5px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[145.2px] w-[512px]" data-name="Primitive.div" />;
}

function ImageWithFallback7() {
  return (
    <div className="relative shrink-0 size-[677.594px]" data-name="ImageWithFallback">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[677.594px]" />
    </div>
  );
}
...
function Container26() {
  return (
    <div className="absolute bg-[#ececf0] content-stretch flex items-center justify-center left-0 overflow-clip size-[678px] top-0" data-name="Container">
      <ImageWithFallback7 />
    </div>
  );
}
...
function Container27() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.9)] box-border content-stretch flex gap-[10px] items-center justify-center left-[302.99px] px-[14px] py-[8px] rounded-[3.35544e+07px] top-[689.59px]" data-name="Container">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap tracking-[-0.48px] whitespace-pre">1 / 4</p>
    </div>
  );
}
...
function Button18() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.9)] content-stretch flex items-center justify-center left-[621px] size-[40px] top-[16px]" data-name="Button">
      <Icon12 />
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute left-[80.3px] size-[678px] top-[-0.2px]" data-name="Container">
      <Container26 />
      <Container27 />
      <Button18 />
    </div>
...
function Button19() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.9)] content-stretch flex items-center justify-center left-0 size-[48px] top-[314.8px]" data-name="Button">
      <Icon13 />
    </div>
  );
}
...
function Button20() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.9)] content-stretch flex items-center justify-center left-[789.59px] size-[48px] top-[314.8px]" data-name="Button">
      <Icon14 />
    </div>
  );
}
...
function ProductDetail2() {
  return (
    <div className="absolute h-[678px] left-[368px] top-[145px] w-[837px]" data-name="ProductDetail">
      <Container28 />
      <Button19 />
      <Button20 />
    </div>
...
export default function ProductSelectedImage() {
  return (
    <div className="bg-white relative size-full" data-name="Product (Selected Image)">
      <App />
      <Text />
      <ProductDetail1 />
      <Text16 />
