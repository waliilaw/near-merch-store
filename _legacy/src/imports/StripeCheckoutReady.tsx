import svgPaths from "./svg-s1k0lm40h7";
...
import { imgGroup } from "./svg-78r4d";
...
function Container8() {
  return (
    <div className="absolute h-[16px] left-[12px] overflow-clip right-[12px] top-[10px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[#313131] text-[14px] text-nowrap top-[8px] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre">Davis Tripp</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute h-[16px] left-[12px] overflow-clip right-[12px] top-[10px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[#313131] text-[14px] text-nowrap top-[8px] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre">123 Speck Alto Adige</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute h-[16px] left-[12px] overflow-clip right-[132px] top-[10px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] left-0 text-[#313131] text-[14px] text-nowrap top-[8px] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre">4242 4242 4242 42442</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute h-[16px] left-[12px] overflow-clip right-[12px] top-[10px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-0 text-[#313131] text-[13.8px] top-[8px] translate-y-[-50%] w-[53.62px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">11 / 29</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="absolute h-[16px] left-[12px] overflow-clip right-[28px] top-[10px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-0 text-[#313131] text-[14px] top-[8px] translate-y-[-50%] w-[29.76px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container17() {
  return (
    <div className="absolute h-[16px] left-[12px] overflow-clip right-[26px] top-[10px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[24px] text-[#313131] text-[14px] top-[8px] translate-y-[-50%] w-[95.95px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">(402) 555-0123</p>
      </div>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="absolute h-[55px] left-[16px] overflow-clip top-0 w-[380px]" data-name="Container">
      <div className="absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[calc(50%+0.5px)] text-[15.8px] text-center text-nowrap text-white top-[27.5px] translate-x-[-50%] translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[55px] whitespace-pre">Processing...</p>
      </div>
    </div>
  );
}
...
function Svg10() {
  return <div className="absolute left-[345px] size-[18px] top-[18.5px]" data-name="SVG" />;
}
...
export default function StripeCheckoutReady() {
  return (
    <div className="bg-white relative size-full" data-name="Stripe Checkout Ready">
