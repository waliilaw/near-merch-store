import svgPaths from "./svg-xcmsxer287";
...
function Text16() {
  return <div className="absolute left-0 opacity-0 size-0 top-[968px]" data-name="Text" />;
}
...
function PrimitiveDiv2() {
  return <div className="absolute bg-[rgba(0,0,0,0.5)] h-[968px] left-0 top-0 w-[1573px]" data-name="Primitive.div" />;
}
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[479px]" data-name="Primitive.h2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-full relative w-[479px]">
        <p className="absolute font-['Red_Hat_Mono:SemiBold',sans-serif] font-semibold leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">Shopping Cart</p>
      </div>
    </div>
  );
}
...
function PrimitiveP() {
  return (
    <div className="h-[20px] relative shrink-0 w-[479px]" data-name="Primitive.p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[479px]">
        <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#717182] text-[14px] text-nowrap top-0 tracking-[-0.48px] whitespace-pre">Review your items and proceed to checkout</p>
      </div>
    </div>
  );
}
...
function Heading7() {
  return (
    <div className="absolute h-[24px] left-0 overflow-clip top-0 w-[359px]" data-name="Heading 4">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">NEAR Protocol Hoodie</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="absolute h-[20px] left-0 top-[24px] w-[359px]" data-name="Paragraph">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#717182] text-[14px] text-nowrap top-0 tracking-[-0.48px] whitespace-pre">Men</p>
    </div>
  );
}
...
function PrimitiveSpan() {
  return (
    <div className="h-[20px] relative shrink-0 w-[15.844px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[20px] items-center overflow-clip relative rounded-[inherit] w-[15.844px]">
        <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap tracking-[-0.48px] whitespace-pre">XS</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton() {
  return (
    <div className="absolute bg-[#f3f3f5] box-border content-stretch flex h-[36px] items-center justify-between left-0 px-[13px] py-px top-[52px] w-[96px]" data-name="Primitive.button">
...
function Container28() {
  return (
    <div className="box-border content-stretch flex h-[88px] items-start justify-between pl-0 py-0 relative shrink-0 w-full" data-name="Container">
      <Container27 />
      <Button18 />
    </div>
  );
...
function Button19() {
  return (
    <div className="opacity-50 relative shrink-0 size-[32px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex items-center justify-center relative size-[32px]">
        <Icon14 />
      </div>
    </div>
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[32px]">
        <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-[16.44px] text-[16px] text-center text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] translate-x-[-50%] whitespace-pre">1</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="h-[34px] relative rounded-[4px] shrink-0 w-[114px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[34px] items-center p-px relative w-[114px]">
        <Button19 />
        <Text17 />
        <Button20 />
      </div>
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[54.734px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[54.734px]">
        <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 top-[-1px] tracking-[-0.48px] w-[55px]">$65.00</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="basis-0 grow h-[130px] min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[8px] h-[130px] items-start relative w-full">
        <Container28 />
        <Container30 />
      </div>
    </div>
...
function Container32() {
  return (
    <div className="box-border content-stretch flex gap-[16px] h-[147px] items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none" />
      <Container26 />
      <Container31 />
    </div>
...
function Container33() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[511px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-full items-start overflow-clip px-[16px] py-0 relative rounded-[inherit] w-[511px]">
        <Container32 />
      </div>
    </div>
  );
...
function Paragraph10() {
  return (
    <div className="h-[24px] relative shrink-0 w-[72.969px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[72.969px]">
        <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">Subtotal</p>
      </div>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[24px] relative shrink-0 w-[54.734px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[54.734px]">
        <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-[54.73px] text-[16px] text-neutral-950 text-nowrap text-right top-[-1px] tracking-[-0.48px] translate-x-[-100%] whitespace-pre">$65.00</p>
      </div>
    </div>
  );
}
...
function Button21() {
  return (
    <div className="bg-neutral-950 h-[36px] relative shrink-0 w-full" data-name="Button">
      <p className="absolute font-['Red_Hat_Mono:Medium',sans-serif] font-medium leading-[20px] left-[207.81px] text-[14px] text-nowrap text-white top-[8px] tracking-[-0.48px] whitespace-pre">Checkout</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Red_Hat_Mono:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px relative shrink-0 text-[#717182] text-[12px] text-center tracking-[-0.48px]">Shipping and taxes calculated at checkout</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="h-[137px] relative shrink-0 w-[511px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[16px] h-[137px] items-start pb-0 pt-[17px] px-[16px] relative w-[511px]">
        <Container34 />
        <Button21 />
        <Paragraph12 />
      </div>
...
function Cart() {
  return (
    <div className="absolute content-stretch flex flex-col h-[846px] items-start left-px top-[122px] w-[511px]" data-name="Cart">
      <Container33 />
      <Container35 />
    </div>
  );
...
function Container36() {
  return (
    <div className="absolute h-[19.5px] left-[40px] top-[17px] w-[78.172px]" data-name="Container">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[13px] text-neutral-950 text-nowrap top-0 tracking-[-0.5562px] whitespace-pre">Added to cart</p>
    </div>
  );
}
...
function Icon17() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path clipRule="evenodd" d={svgPaths.p19773c80} fill="var(--fill-0, #0A0A0A)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container37() {
  return (
    <div className="absolute box-border content-stretch flex items-center left-[14px] pr-0 py-0 size-[16px] top-[18.75px]" data-name="Container">
      <Icon17 />
    </div>
  );
}
...
function Notification() {
  return (
    <div className="absolute bg-white h-[53.5px] left-[132px] rounded-[8px] top-[890.5px] w-[356px]" data-name="Notification">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.1)]" />
      <Container36 />
      <Container37 />
    </div>
  );
...
function PrimitiveDiv3() {
  return (
    <div className="absolute bg-white h-[968px] left-[1061px] top-0 w-[512px]" data-name="Primitive.div">
...
export default function ProductAddedToCard() {
  return (
    <div className="bg-white relative size-full" data-name="Product (Added to Card)">
      <App />
      <Text />
      <ProductDetail1 />
      <Text16 />
